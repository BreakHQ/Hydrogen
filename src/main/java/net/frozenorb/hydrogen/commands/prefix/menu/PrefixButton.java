...
extends Button {
    ...
    public List<String> getDescription(Player player) {
        ...
        description.add((Object)ChatColor.BLUE + "Click to grant " + (Object)ChatColor.WHITE + this.targetName + (Object)ChatColor.BLUE + " the " + (Object)ChatColor.WHITE + this.prefix.getDisplayName() + (Object)ChatColor.BLUE + " prefix.");
        description.add(ChatColor.GRAY.toString() + (Object)ChatColor.STRIKETHROUGH + StringUtils.repeat((char)'-', (int)30));
        return description;
    }
    ...
    public void clicked(final Player player, int i, ClickType clickType) {
        ...
        ConversationFactory factory = new ConversationFactory((Plugin)Hydrogen.getInstance()).withModality(true).withPrefix((ConversationPrefix)new NullConversationPrefix()).withFirstPrompt((Prompt)new StringPrompt(){
            ...
            public String getPromptText(ConversationContext context) {
                return (Object)ChatColor.YELLOW + "Please type a reason for this prefix grant to be added, or type " + (Object)ChatColor.RED + "cancel" + (Object)ChatColor.YELLOW + " to cancel.";
            }
    ...
    private DyeColor getColor() {
        ...
        ChatColor color = ChatColor.getByChar((char)lastColors.charAt(lastColors.indexOf(167) + 1));
        switch (color) {
            case DARK_BLUE: {
